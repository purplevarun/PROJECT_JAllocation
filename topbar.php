...
<div style="width:100%;font-size:20px;height:43px;background-color:black;margin:0px;padding:0px;">
    ...
    <button style="margin:4px;float:right;background-color:white;border-style:groove;border-radius:5px;" onclick="document.body.style.color='black';document.body.style.backgroundColor='white';">Dark Mode</button>
